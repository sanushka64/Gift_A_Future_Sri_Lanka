...
export default function Goverment({ user, onTabChange, activeTab, onSponsorClick, onSignOut }) {
  ...
  const [posts, setPosts] = useState([
    ...
    },
    {
      ...
      category: "Nutrition",
      shortStory: "Underweight and malnourished due to food insecurity.",
      fullStory:
    ...
    <>
      ...
      <div style={{ padding: "40px" }}>
        <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "20px" }}>
          Government Dashboard - Child Profiles
        </h2>
        ...
        <div style={{ marginTop: "20px" }}>
          <button onClick={onSignOut} style={backBtn}>
            ← Back / Sign Out
          </button>
        </div>
      </div>
